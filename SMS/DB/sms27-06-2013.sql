...
insert  into `locations`(`LocationId`,`DeploymentId`,`LocationName`) values (1,2,'Location 111'),(4,2,'Rajahmundry');
...
insert  into `passes`(`PassId`,`PassName`,`PassStatus`,`VisitortypeId`,`DeploymentId`) values (6,'pass 222','1',3,2);
