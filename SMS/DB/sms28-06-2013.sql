...
insert  into `companies`(`CompanyId`,`CompanyName`,`Address`,`ContactNumber`,`DeploymentId`) values (2,'Keerti Technologies','Hyd','',2),(3,'Microsoft','HYD','999998888',1),(4,'Company 5656','HYD','234566',2),(5,'WESTMERE EXEC CONDO','','',8);
...
insert  into `gates`(`GateId`,`DeploymentId`,`GateName`,`AddedDate`) values (1,1,'Gate 444','2013-01-24 00:00:00'),(2,2,'Gate 88','2013-01-25 00:00:00'),(4,2,'Gate 786','2013-02-06 00:00:00'),(5,8,'Gate1','2013-06-27 00:00:00');
...
insert  into `incidents`(`incidentid`,`reportdate`,`natureofincident`,`dateofincident`,`locationid`,`particularsofpersons`,`briefdescription`,`remarksandactionstaken`,`snapshotpath`,`deploymentid`) values (1,'2013-04-21 16:27:10','Stolen','2013-02-24 00:00:00',2,'qwerqwr','This incident','sdfasfsf','../Snapshots/2013421162718741.png',2),(3,'2013-03-21 09:15:57','car','2012-01-04 10:24:00',1,'id=\"incidentTime\"','','','~/Content/images/incident.jpg',2),(8,'2013-03-21 21:00:19','bus accident','2013-01-15 11:17:00',1,'hari','','','~/Content/images/incident.jpg',4),(9,'2013-03-22 07:37:48','theft','2013-04-20 16:19:00',1,'raj','','','~/Content/images/incident.jpg',4),(10,'2013-06-26 16:24:14','Good work','2013-01-01 00:00:00',4,'','','',NULL,2),(11,'2013-06-26 16:25:14','appreciation','2013-07-17 16:17:00',4,'','','',NULL,2);
...
insert  into `keys`(`KeyId`,`KeyName`,`DeploymentId`,`Status`,`AddedDate`) values (2,'New key',2,1,'2013-03-20 00:00:00'),(3,'dfdf',8,3,'2013-06-27 00:00:00');
...
insert  into `locations`(`LocationId`,`DeploymentId`,`LocationName`) values (1,2,'Location 111'),(4,2,'Rajahmundry'),(5,8,'SINGAPORE');
...
insert  into `passes`(`PassId`,`PassName`,`PassStatus`,`VisitortypeId`,`DeploymentId`) values (6,'pass 222','1',3,2),(7,'Pass1','1',2,8);
