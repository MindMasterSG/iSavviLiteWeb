    ...
    public class SMSManagementModel
    {
        ...
        public List<VisitorCheckInOut> GetVisitorCheckInOut(int currentUserType, int deploymentId,string searchString)
        {
            ...
            foreach (VisitorCheckInOut visitorcheckinout in objVisitorCheckInOuts)
            {
                ...
                objVisitorCheckInOut.visitorid = visitorcheckinout.visitorid;
                ...
                objVisitorCheckInOut.NRICBack = visitorcheckinout.NRICBack;
                objVisitorCheckInOut.NRICFront = visitorcheckinout.NRICFront;
                ...
                objVisitorCheckInOut.IsBlockGuest = visitorcheckinout.IsBlockGuest;
                if (visitorcheckinout.BlockedDate!=null) {
                    objVisitorCheckInOut.BlockedDate = visitorcheckinout.BlockedDate;
                    //objVisitorCheckInOut.BlockedDate = Convert.ToDateTime(visitorcheckinout.BlockedDate.ToString("MM/dd/yyyy"));
                    //DateTime.ParseExact(visitorcheckinout.BlockedDate.ToString(), "MM/dd/yyyy", CultureInfo.InstalledUICulture);
                    objVisitorCheckInOut.strBlockedDate = objVisitorCheckInOut.BlockedDate.ToString();
                }
                if (visitorcheckinout.UnblockedDate != null)
                {
                    objVisitorCheckInOut.UnblockedDate = visitorcheckinout.UnblockedDate;
                    //objVisitorCheckInOut.UnblockedDate = DateTime.ParseExact(visitorcheckinout.UnblockedDate.ToString(), "MM/dd/yyyy", CultureInfo.InstalledUICulture);
                    objVisitorCheckInOut.strUnblockedDate = visitorcheckinout.UnblockedDate.ToString();
                }
                objVisitorCheckInOut.BlockDays = visitorcheckinout.BlockDays;
                objVisitorCheckInOut.BlockType = visitorcheckinout.BlockType;
                objVisitorCheckInOut.BlockRemarks = visitorcheckinout.BlockRemarks;
        ...
        public List<VisitorCheckInOut> GetVisitorCheckInOutByFilters(int currentUserType, int deploymentId,int startdate, int startmonth, int startyear, int enddate, int endmonth, int endyear)
        {
            ...
            foreach (VisitorCheckInOut visitorcheckinout in objVisitorCheckInOuts)
            {
                ...
                //objVisitorCheckInOut.visitingcompany = visitorcheckinout.visitingcompany;
                Companies c = objSMS.GetCompanyByID(visitorcheckinout.tocompany);
        ...
        public VisitorCheckInOut GetVisitorCheckInOutByID(int currentUserType, int deploymentId, string ID, int p_EventId,int p_VisitorTypeId)
        {
            ...
            if (visitorcheckinout != null)
            {
                ...
                objVisitorCheckInOut.telno = visitorcheckinout.telno;
                objVisitorCheckInOut.temp = Convert.ToInt32(visitorcheckinout.temp);
                objVisitorCheckInOut.tocompany = visitorcheckinout.tocompany;
            ...
            objVisitorCheckInOut.PurposeList = objSMS.GetPurposes(currentUserType, deploymentId,"");
        ...
        {
            Vehicles objVehicleMaster = new Vehicles();

            Vehicles vehiclemaster = ID == "" ? null : objSMS.GetVehicleByID(currentUserType, deploymentId, ID);
            if (vehiclemaster != null)
            {
                objVehicleMaster.vehicleid = vehiclemaster.vehicleid;
                objVehicleMaster.authpersonic = vehiclemaster.authpersonic;
                objVehicleMaster.authpersonname = vehiclemaster.authpersonname;
                objVehicleMaster.capacity = vehiclemaster.capacity;
                objVehicleMaster.containernumber = vehiclemaster.containernumber;
                objVehicleMaster.contractor = vehiclemaster.contractor;
                objVehicleMaster.description = vehiclemaster.description;
                objVehicleMaster.imagepath = vehiclemaster.imagepath;
                objVehicleMaster.length = vehiclemaster.length;
                objVehicleMaster.platenumber = vehiclemaster.platenumber;
                objVehicleMaster.securityguardname = vehiclemaster.securityguardname;
                objVehicleMaster.trailernumber = vehiclemaster.trailernumber;
                objVehicleMaster.deploymentid = vehiclemaster.deploymentid;
                objVehicleMaster.vehicletype = vehiclemaster.vehicletype;
                objVehicleMaster.purpose = vehiclemaster.purpose;
                objVehicleMaster.LocationName = vehiclemaster.LocationName;
            }
            objVehicleMaster.VehicleTypesList = objSMS.GetVehiclesType(currentUserType, deploymentId,null);
            objVehicleMaster.PurposeList = objSMS.GetPurposes(currentUserType, deploymentId, null);
            //objVehicleMaster.LocationList = objSMS.GetLocationsList(currentUserType, deploymentId);
